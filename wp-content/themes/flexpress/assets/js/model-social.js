...
(function($) {
    ...
    window.showLoginPrompt = function(platform) {
        ...
        const modelName = $('h1.hero-episode-title').first().text().trim() || 
                         $('.model-section-heading').first().text().replace('Connect with ', '').trim() ||
                         'this model';
                ...
                <div class="social-login-modal">
                    ...
                    <div class="social-modal-content">
                        ...
                        <ul class="social-modal-benefits">
                            ...
                            <li><i class="fas fa-check-circle"></i> Direct messaging with models</li>
                        ...
                        <div class="social-modal-actions">
                            <a href="/login/?redirect=' + encodeURIComponent(window.location.href) + '" class="btn-social-login">
                                <i class="fas fa-sign-in-alt"></i>
                                Log In to Continue
                            </a>
                            <a href="/register/" class="btn-social-register">
