    ...
    <?php if (!flexpress_is_coming_soon_enabled()): ?>
        <!-- Content to hide when coming soon is active -->
            ...
            <div class="container">
                ...
                <div class="row bottom-text">
                    <div class="col-12 text-center mt-4">
                        ...
                        if (!empty($general_settings['dolls_downunder_network']) && $general_settings['dolls_downunder_network'] === '1') :
