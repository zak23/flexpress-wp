...
class FlexPress_Flowguard_Settings {
    ...
    public function sanitize_settings($input) {
        ...
        if (isset($input['environment'])) {
            $sanitized['environment'] = in_array($input['environment'], ['sandbox', 'production']) 
                ? $input['environment'] 
                : 'sandbox';
        }
    ...
    public function render_environment_field() {
        ...
        <p class="description">Select your environment. Use Sandbox for testing, Production for live payments.</p>
        <?php
    }
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $environment = $options['environment'] ?? 'sandbox';
                        $env_color = $environment === 'production' ? 'orange' : 'blue';
                        ?>
                        <span style="color: <?php echo $env_color; ?>;">
