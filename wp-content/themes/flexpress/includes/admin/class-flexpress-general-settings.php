...
?>
    ...
    {
        $options = get_option('flexpress_general_settings');
        $value = isset($options['accent_color']) ? $options['accent_color'] : '#28a745';
    ?>
        <input type="color"
            ...
            class="color-picker">
        <p class="description">
            <?php esc_html_e('Choose an accent color for buttons, links, and important elements. Default is green (#28a745).', 'flexpress'); ?>
        </p>
