...
?>
    ...
    public function render_user_activity_log($user_id)
    {
        ...
        <style>
            ...
            .activity-verotel-initial {
                background-color: #28a745;
            }

            .activity-verotel-rebill {
                background-color: #17a2b8;
            }

            .activity-verotel-cancellation {
                background-color: #dc3545;
            }

            .activity-verotel-uncancel {
                background-color: #28a745;
            }

            .activity-verotel-extend {
                background-color: #ffc107;
                color: #212529;
            }

            .activity-verotel-expiration {
                background-color: #6c757d;
            }

            .activity-verotel-downgrade {
                background-color: #fd7e14;
            }

            .activity-verotel-upgrade {
                background-color: #20c997;
            }

            .activity-verotel-credit {
                background-color: #6f42c1;
            }

            .activity-verotel-chargeback {
            ...
            .activity-membership-status-change {
                background-color: #00a0d2;
            }

            .activity-ppv-purchase {
                background-color: #28a745;
            }

            .activity-ppv-purchase-confirmed {
                background-color: #20c997;
            }

            .activity-verotel-unknown {
                background-color: #6c757d;
            }
                ...
                if (!empty($release_date)) {
                    ...
                    if (preg_match('/^\d{2}\/\d{2}\/\d{4} \d{2}:\d{2} [ap]m$/i', $release_date)) {
                        ...
                        $formatted_date = sprintf(
                            ...
                            $date_parts[2] === 'pm' && $time_parts[0] != 12 ? intval($time_parts[0]) + 12 : ($date_parts[2] === 'am' && $time_parts[0] == 12 ? 0 : intval($time_parts[0])), // Hour
