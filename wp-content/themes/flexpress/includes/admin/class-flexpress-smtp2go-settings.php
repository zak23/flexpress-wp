...
class FlexPress_SMTP2Go_Settings {
    ...
    public function __construct() {
        ...
        // Debug: Log that SMTP2Go settings class is instantiated
        error_log('FlexPress SMTP2Go Settings: Constructor called');
    }
    ...
    public function register_settings() {
        // Debug: Log that settings are being registered
        error_log('FlexPress SMTP2Go Settings: register_settings called');
    ...
    public function sanitize_settings($input) {
        ...
        error_log('FlexPress SMTP2Go Settings: sanitize_settings called with input: ' . print_r($input, true));
        ...
        error_log('FlexPress SMTP2Go Settings: sanitized output: ' . print_r($sanitized, true));
