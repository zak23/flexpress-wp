                    ...
                    <?php if (!empty($collection_meta['featured_image'])): ?>
                        <div class="col-lg-4 col-md-5 mb-4 mb-lg-0">
                            <div class="collection-featured-image">
                                ...
                                if (is_array($image)) {
                                    echo '<img src="' . esc_url($image['sizes']['large']) . '" alt="' . esc_attr($current_tag->name) . '" class="img-fluid rounded shadow">';
                                } else {
                                    echo '<img src="' . esc_url($image) . '" alt="' . esc_attr($current_tag->name) . '" class="img-fluid rounded shadow">';
                                }
                                ?>
                            </div>
                        </div>
                        ...
                        <?php else: ?>
                            ...
                            <div class="collection-info">
                                <h1 class="collection-title display-4 mb-3">
                                    <?php echo esc_html($current_tag->name); ?>
                                    <span class="collection-badge badge bg-primary ms-2">Collection</span>
                                </h1>

                                <?php if (!empty($collection_meta['description'])): ?>
                                    <div class="collection-description lead mb-4">
                                ...
                                <div class="collection-stats">
                                    ...
                                    <?php if ($collection_meta['episode_order']): ?>
                                        <span class="badge bg-info">
                                            <i class="fas fa-sort me-1"></i>
                                            <?php echo esc_html(ucfirst($collection_meta['episode_order'])); ?> Order
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
