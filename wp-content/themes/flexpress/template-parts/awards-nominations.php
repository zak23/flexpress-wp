                        ...
                        <div class="awards-slider" id="awardsSlider">
                            <?php foreach ($awards_data['awards'] as $award): ?>
                                <?php if (!empty($award['logo_url'])): ?>
                                    ...
                                    // Match display size 92x60
                                    if (function_exists('flexpress_get_bunnycdn_optimized_image_url')) {
                                        $optimized_logo_url = flexpress_get_bunnycdn_optimized_image_url($award['logo_url'], array(
                                            'width' => 92,
                                            'height' => 60,
                                            'format' => 'webp',
                                            'quality' => 60
                                        ...
                                        $optimized_logo_url = $award['logo_url'];
                                    }
                                    ?>
                                        ...
                                        <div class="text-center d-flex flex-column align-items-center">
                                            <?php if (!empty($award['link'])): ?>
                                                <a href="<?php echo esc_url($award['link']); ?>" target="_blank" class="d-inline-block award-link-carousel" rel="noopener">
                                                    <img src="<?php echo esc_url($optimized_logo_url); ?>"
